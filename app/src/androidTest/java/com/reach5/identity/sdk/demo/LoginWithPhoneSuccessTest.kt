...
class LoginWithPhoneSuccessTest {
    ...
    fun loginWithPhoneSuccessTest() {
        ...
        appCompatEditText.perform(scrollTo(), replaceText("0605040302"), closeSoftKeyboard())
        ...
        textView.check(matches(withText("+33605040302")))
    }
